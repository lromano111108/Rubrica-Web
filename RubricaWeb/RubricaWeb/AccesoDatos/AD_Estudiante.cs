...
namespace RubricaWeb.AccesoDatos
{
    public class AD_Estudiante
    {
        ...
        public static bool AgregarEstudianteAValoracion(int idEstudiante, int idTema)
        {
            bool resultado = false;
            string cadenaConexion = System.Configuration.ConfigurationManager.AppSettings["CadenaBD"].ToString();
            ...
            try
            {
                cn.Open();
                SqlCommand cmd = cn.CreateCommand();
                cmd.CommandText = "sp_insertarValoracionCriterio";
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                //string consulta = @"EXEC sp_InsertarDocenteXMateria (@idMateria, @idDocente)";
                cmd.Parameters.Clear();
                cmd.Parameters.Add(new SqlParameter("@idEstudiante", idEstudiante));
        ...
        public static List<Materia> ListadoIdMateria(int idCurso)
        {
            ...
            try
            {
                ...
                string consulta = @"select idMateria from materias
        ...
        public static List<VM_Tema> ListadoTemasPorMateria(int idMateria)
        {
            ...
            try
            {
                ...
                string consulta = @"select idTema from temas
                ...
                if (dr != null)
                {
                    while (dr.Read())
                    {
                        VM_Tema itemsLista = new VM_Tema();
        ...
        public static int ultimoIdEstudiante()
        {
            int resultado = 0;
            string cadenaConexion = System.Configuration.ConfigurationManager.AppSettings["CadenaBD"].ToString();
            ...
            try
            {
                ...
                string consulta = @"select MAX(idEstudiante) as 'id' from Estudiantes";
                cmd.Parameters.Clear();
